...
console.log(cloneGraph(_Node.fromArray([[1, 2, 4], [1, 3], [2], [1, 3]]))); // [[1,2,4],[1,3],[2],[1,3]]

console.log(cloneGraph(_Node.fromArray([[2], [1]]))); // [[2],[1]]

console.log(cloneGraph(_Node.fromArray([[1, 2], [1], [1]]))); // [[1,2],[1],[1]]

console.log(cloneGraph(_Node.fromArray([[1, 2], [1], [1], [1]]))); // [[1,2],[1],[1],[1]]
